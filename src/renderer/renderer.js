...
class WiFiTriangulationApp {
    ...
    setButtonLoading(btn, isLoading) {
        ...
        if (isLoading) {
            ...
            // Ensure contrast on primary buttons
            const spinnerColor = isPrimary ? 'border-color: rgba(255,255,255,0.3); border-top-color: #ffffff;' : '';
            btn.innerHTML = `<div class="spinner" style="display: inline-block; vertical-align: middle; margin-right: 8px; ${spinnerColor}"></div>Loading...`;
        } else {
