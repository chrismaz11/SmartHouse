...
class WiFiTriangulationApp {
    ...
    updateDashboard() {
        ...
        `;
        this.updateContainerIfChanged('network-status', networkHtml);
        ...
        const apHtml = `
            ...
            `).join('')}
        `;
        this.updateContainerIfChanged('ap-status', apHtml);
        ...
        `;
        this.updateContainerIfChanged('automation-status', automationHtml);
    }
